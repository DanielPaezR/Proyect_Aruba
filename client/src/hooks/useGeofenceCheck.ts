 ...
 * deja un registro de referencia de proximidad a la oficina (ver
 * GeofenceProximityLog en el backend). El marcado real siempre lo hace el
 * trabajador a mano. Nunca molesta al usuario: sin geolocalizacion
 * disponible, permiso denegado, o error de red, simplemente no hace nada —
